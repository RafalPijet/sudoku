import { SET_BOARD, SET_INITIAL_BOARD, SET_TURNS, SET_TURNS_CASH,
    ADD_TURN, REMOVE_TURN, ADD_TURN_CASH, REMOVE_TURN_CASH } from "../actions/boardsActions";
...
const boards = (state = {}, action) => {
    switch (action.type) {
        ...
        case SET_INITIAL_BOARD:
            return ({ ...state, initialBoard: action.board });
        case SET_TURNS:
            return ({ ...state, turns: action.board });
        case ADD_TURN:
